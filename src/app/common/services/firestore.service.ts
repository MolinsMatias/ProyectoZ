...
export class FirestoreService {
  getCollectionQuery<T>(arg0: string, arg1: (ref: any) => any) {
  ...
  deleteDocument(enlace: string): Promise<void> {
    const document = doc(this.firestore, enlace); // Usamos la función modular 'doc'
    return deleteDoc(document); // Usamos 'deleteDoc' para eliminar el documento
  }
}
